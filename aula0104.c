 ...
 * Descricao: Programa que exibe o tamanho em bytes das combinacoes entre modificadores de sinal e de largura
 *
 * $Author: leticia.santos $
 * $Date: 2019/04/01 22:42:19 $
 * $Log: aula0104.c,v $
 * Revision 1.2  2019/04/01 22:42:19  leticia.santos
 * *** empty log message ***
 *
 * Revision 1.1  2019/03/29 23:24:57  leticia.santos
 * Initial revision
 *
 *
 */
