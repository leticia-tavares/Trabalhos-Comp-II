 ...
 * Descricao: Programa que exibe o tamanho em bytes das combinacoes entre tipos basicos e modificadores de largura
 *
 * $Author: leticia.santos $
 * $Date: 2019/04/01 22:43:40 $
 * $Log: aula0106.c,v $
 * Revision 1.3  2019/04/01 22:43:40  leticia.santos
 * *** empty log message ***
 *
 * Revision 1.2  2019/04/01 22:32:09  leticia.santos
 * *** empty log message ***
 *
 * Revision 1.1  2019/03/30 02:08:29  leticia.santos
 * Initial revision
 *
 *
 */
